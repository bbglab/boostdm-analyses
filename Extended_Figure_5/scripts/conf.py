...
selecte_ttypes=['LGG', 'RCCC', 'PAAD', 'BLCA', 'OS', 'SCLC', 'HNSC', 'UCEC', 'HGG', 'OV', 'COREAD', 'BRCA', 'UCS', 'PRAD', 'HC', 'GBM', 'CESC', 'LUAD', 'LUSC', 'ST', 'ESCA', 'UVM', 'DLBCL', 'CH', 'AML', 'MBL', 'CLL', 'PIA', 'MM', 'NB', 'ALL', 'CM', 'SBCC', 'NHLY', 'THYM', 'THCA', 'RPC', 'S', 'ACC', 'RCH', 'PCPG', 'PAIS', 'NSPH', 'MESO', 'LUNG_CANCER', 'LEIS', 'EWS', 'MGCT']
# path samples
